...
class StudentEvaluation(models.Model):
	"""
	Model for per-student evaluations (First and Second stages).
	Each student receives individual marks from both guide and coordinator.
	"""
	STAGE_CHOICES = [
		("first", "First Evaluation"),
		("second", "Second Evaluation"),
	...
	# Guide marks (out of 40 total)
	guide_topic = models.IntegerField(null=True, blank=True, help_text="Topic identification / literature survey (5)")
	guide_planning = models.IntegerField(null=True, blank=True, help_text="Project planning / scheduling / resources / innovative design (5)")
	guide_scalability = models.IntegerField(null=True, blank=True, help_text="Scalability and reliability (2)")
	guide_novelty = models.IntegerField(null=True, blank=True, help_text="Novelty of idea and implementation scope (5)")
	guide_task_distribution = models.IntegerField(null=True, blank=True, help_text="Task distribution among team members (5)")
	guide_schedule = models.IntegerField(null=True, blank=True, help_text="Adherence to project schedule (3)")
	guide_interim = models.IntegerField(null=True, blank=True, help_text="Interim results (5)")
	guide_presentation = models.IntegerField(null=True, blank=True, help_text="Presentation (5)")
	guide_viva = models.IntegerField(null=True, blank=True, help_text="Viva (5)")
	guide_submitted = models.BooleanField(default=False)

	# Coordinator marks (out of 40 total)
	coordinator_topic = models.IntegerField(null=True, blank=True, help_text="Topic identification / literature survey (5)")
	coordinator_planning = models.IntegerField(null=True, blank=True, help_text="Project planning / scheduling / resources / innovative design (5)")
	coordinator_scalability = models.IntegerField(null=True, blank=True, help_text="Scalability and reliability (2)")
	coordinator_novelty = models.IntegerField(null=True, blank=True, help_text="Novelty of idea and implementation scope (5)")
	coordinator_task_distribution = models.IntegerField(null=True, blank=True, help_text="Task distribution among team members (5)")
	coordinator_schedule = models.IntegerField(null=True, blank=True, help_text="Adherence to project schedule (3)")
	coordinator_interim = models.IntegerField(null=True, blank=True, help_text="Interim results (5)")
	coordinator_presentation = models.IntegerField(null=True, blank=True, help_text="Presentation (5)")
	coordinator_viva = models.IntegerField(null=True, blank=True, help_text="Viva (5)")
	coordinator_submitted = models.BooleanField(default=False)
	...
	def guide_total(self):
		"""Calculate total guide marks (out of 40)."""
		marks = [
	...
	def coordinator_total(self):
		"""Calculate total coordinator marks (out of 40)."""
		marks = [
	...
	def average_total(self):
		"""Calculate average of guide and coordinator marks."""
		if self.finalized:
			return (self.guide_total + self.coordinator_total) / 2
		return None
